...
function Register(props) {
    ...
    return (<div className="form-container">
      <form className="registration-form" onSubmit={handleSubmit}>
        ...
        <input className="input" value={name} onChange={(e) => setName(e.target.value)} type="name" placeholder="Full Name" id="name" name="name" autoComplete="given-name"/>
      ...
      <button className="button" type="submit" onClick={() => props.onFormSwitch("login")}>
        Register
      </button>
    </div>);
}
